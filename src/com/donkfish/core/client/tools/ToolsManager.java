...
public class ToolsManager {
    ...
    public static final String TOOL_KEY_CSV_ENCODER = "Csv_Encoder";
    public static final String TOOL_KEY_CSV_DECODER = "Csv_Decoder";
        public static final String TOOL_KEY_JAVA_ENCODER = "Java_Encoder";
    public static final String TOOL_KEY_JAVA_DECODER = "Java_Decoder";
        public static final String TOOL_KEY_JS_ENCODER = "Js_Encoder";
    public static final String TOOL_KEY_JS_DECODER = "Js_Decoder";
    ...
    public static final String TOOL_KEY_URL_ENCODER = "Url_Encoder";
    public static final String TOOL_KEY_URL_DECODER = "Url_Decoder";
    public static final String TOOL_KEY_REGEX_ENCODER = "Regex_Encoder";
    public static final String TOOL_KEY_REGEX_DECODER = "Regex_Decoder";
...
//            tools.put(TOOL_KEY_MODE_TOOL, new Tool("Mode Tool", "Add up all the numbers in a list", ""));
            ...
            tools.put(TOOL_KEY_URL_ENCODER, new Tool("URL Encoder", "Add up all the numbers in a list", ""));
            tools.put(TOOL_KEY_URL_DECODER, new Tool("URL Decoder", "Add up all the numbers in a list", ""));
            tools.put(TOOL_KEY_REGEX_ENCODER, new Tool("Regex Encoder", "Add up all the numbers in a list", ""));
            tools.put(TOOL_KEY_REGEX_DECODER, new Tool("Regex Decoder", "Add up all the numbers in a list", ""));
                        tools.put(TOOL_KEY_CSV_ENCODER, new Tool("CSV Encoder", "Add up all the numbers in a list", ""));
            tools.put(TOOL_KEY_CSV_DECODER, new Tool("CSV Decoder", "Add up all the numbers in a list", ""));
                        tools.put(TOOL_KEY_JAVA_ENCODER, new Tool("JAVA Encoder", "Add up all the numbers in a list", ""));
            tools.put(TOOL_KEY_JAVA_DECODER, new Tool("JAVA Decoder", "Add up all the numbers in a list", ""));
                        tools.put(TOOL_KEY_JS_ENCODER, new Tool("JS Encoder", "Add up all the numbers in a list", ""));
            tools.put(TOOL_KEY_JS_DECODER, new Tool("JS Decoder", "Add up all the numbers in a list", ""));
